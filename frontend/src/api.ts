...
export const createSurvey = async (
    ...
    const response = await fetch(`${BACKEND_URL}/add/survey-with-data`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify({
...
export const getSurvey = async (surveyId: number) => {
    const response = await fetch(`${BACKEND_URL}/survey/${surveyId}`, {
        credentials: "include",
    });
...
export const addAnswer = async (
    ...
    const response = await fetch(`${BACKEND_URL}/add/answer/${questionId}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
...
export const joinSurvey = async (surveyId: number) => {
    const response = await fetch(`${BACKEND_URL}/survey/${surveyId}/join`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
    });
...
export const getSurveyData = async (surveyId: number) => {
    const response = await fetch(`${BACKEND_URL}/survey/${surveyId}/data`, {
        credentials: "include",
    });
...
export const updateAvailability = async (
    ...
    const response = await fetch(
        `${BACKEND_URL}/survey/${surveyId}/availability`,
        {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
...
export const addIdea = async (
    ...
    const response = await fetch(`${BACKEND_URL}/survey/${surveyId}/ideas`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
...
export const voteIdea = async (ideaId: number, voteType: "up" | "down") => {
    const response = await fetch(`${BACKEND_URL}/idea/${ideaId}/vote`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
...
export const initializeSurvey = async (surveyId: number) => {
    const response = await fetch(
        `${BACKEND_URL}/survey/${surveyId}/initialize`,
        {
            method: "POST",
            credentials: "include",
        },
